...
export const speakers = [
  ...
  { name: 'Iván Ordóñez', role: 'Consultor de empresas y gobiernos en estrategia de agronegocios. Investigador en el área de Desarrollo Económico de CIPPEC', bio: 'Consultor de empresas y gobiernos en estrategia de agronegocios. Investigador en el área de Desarrollo Económico de CIPPEC.', photo: '/oradores/Ivan Ordoñez.jfif' },
...
export const schedule = [
  {
    ...
    items: [
      ...
      { time: '10:50 h', title: 'Desarrollando "Vaca Viva" en el Chaco Argentino', desc: 'Una experiencia productiva con foco en el desarrollo regional, por Juan Manuel Garzón.', type: 'auditorio' },
      { time: '12:00 h', title: 'Liderar para transformar: el desafío de impulsar el cambio en la región', desc: 'La visión de CREA como motor del crecimiento y la transformación regional, por Fernando de Nevares e Iván Ordóñez.', type: 'auditorio' },
      { time: '13:00 h', title: 'Almuerzo', type: 'patio' },
      ...
      { time: '16:00 h', title: 'Empresas que impulsan el desarrollo regional', desc: 'Oradores a confirmar.', type: 'auditorio' },
      { time: '16:30 h', title: 'Coffee break', type: 'patio' },
      { time: '17:00 h', title: 'Perspectivas del mercado de granos', desc: 'El escenario actual de los mercados, las tendencias de precios y las claves para anticiparse y tomar mejores decisiones, por Paulina Lescano.', type: 'auditorio' },
      ...
      { time: '18:10 h', title: 'Uso de inteligencia artificial en el agro', desc: 'Aplicaciones concretas de inteligencia artificial en la producción y gestión, por Pedro Meriggiola.', type: 'auditorio' },
  ...
  },
  {
    ...
    items: [
      ...
      { time: '08:30 h', title: 'Liderazgo y autoliderazgo', desc: 'Claves para liderar y liderarse en contextos desafiantes, por Juan Marcos Olivero Vila.', type: 'auditorio' },
      { time: '08:30 h', title: 'Mesas con foco técnico', desc: 'Intercambio sobre producción, tecnología y manejo para mejorar resultados en el campo.', type: 'conexiones' },
      { time: '09:10 h', title: 'El punto ciego: claves para diagnosticar el capital humano', desc: 'Una mirada sobre los desafíos de gestionar personas y equipos, por Fernando Preumayr.', type: 'auditorio' },
      ...
      { time: '11:00 h', title: 'Ganadería CREA: conocimiento que transforma', desc: 'Una mirada sobre los principales desafíos, oportunidades y herramientas para el desarrollo de la ganadería, por Rafael Mortarotti y Erika Schild.', type: 'auditorio' },
...
export const sponsors = {
  ...
  patrocinantes: [
    ...
    { name: 'Agross',     logo: '/sponsors/Patrocinante/Agross.jpg',                                                 imgClass: 'scale-[2.0]' },
    { name: 'Las Marías', logo: '/sponsors/Patrocinante/LA MERCED - NUEVO.png',                                     imgClass: 'scale-[1.4]' },
    { name: 'Ligier',     logo: '/sponsors/Patrocinante/ligier.png' },
    { name: 'Nidera',     logo: '/sponsors/Patrocinante/nidera.png' },
    { name: 'Rizobacter', logo: '/sponsors/Patrocinante/rizobacter.png' },
  ...
  auspiciantes: [
    ...
    { name: 'Agrofertil',            logo: '/sponsors/Auspiciante/agrofertil.png' },
    ...
    { name: 'Criolani',              logo: '/sponsors/Auspiciante/criolani.png' },
    ...
    { name: 'Ganaderos de Ceres',    logo: '/sponsors/Auspiciante/ganaderos-de-ceres.png' },
    { name: 'Grupo MVC Bovcal',      logo: '/sponsors/Auspiciante/bovcal.png' },
    { name: 'Grupo Perez Curbelo',   logo: '/sponsors/Auspiciante/GPCLogos.png' },
    { name: 'Hotel Hilton',          logo: '/sponsors/Auspiciante/hilton.png' },
    { name: 'Chelala',               logo: '/sponsors/Auspiciante/chelala.png' },
    { name: 'OSDE',                  logo: '/sponsors/Auspiciante/osde.png' },

    ...
    <footer id="contacto" className="mt-10 bg-forest-800 text-cream">
      <div className="container-x py-16 grid md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <p className="text-sm text-cream font-medium">{contact.person}</p>
          <p className="text-xs text-cream/60 mb-3">{contact.role}</p>
          ...
          <div className="flex gap-3 mt-5">
            <a href={contact.social.instagram} aria-label="Instagram" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-cream/20 grid place-content-center hover:bg-terracotta-500 hover:border-terracotta-500 transition"><FaInstagram /></a>
          </div>
        </div>
      </div>
